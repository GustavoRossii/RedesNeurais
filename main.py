...
class MLP:
    def __init__(self, tamanhos_camadas, funcao_ativacao, derivada_ativacao):
        ...
        self.pesos = [np.random.randn(y, x+1) * np.sqrt(2. / (x + y)) for x, y in zip(tamanhos_camadas[:-1], tamanhos_camadas[1:])]
...
def testar_configuracao(X, y, tamanhos_camadas, funcao_ativacao, derivada_ativacao, epocas, taxa_aprendizado, tamanho_lote, amostras):
...
#configs 
configuracoes = [
    {"camadas": [X.shape[1], 128, 64, 32, 16, 1], "ativacao": (relu, derivada_relu), "taxa": 0.001, "epocas": 1000, "tamanho_lote": 32, "amostras": 1000, "nome": "ReLU"},
    {"camadas": [X.shape[1], 128, 64, 32, 16, 1], "ativacao": (tanh, derivada_tanh), "taxa": 0.001, "epocas": 1000, "tamanho_lote": 32, "amostras": 1000, "nome": "Tanh"},
    {"camadas": [X.shape[1], 128, 64, 32, 16, 1], "ativacao": (sigmoid, derivada_sigmoid), "taxa": 0.001, "epocas": 1000, "tamanho_lote": 32, "amostras": 1000, "nome": "Sigmoid"},
    {"camadas": [X.shape[1], 128, 64, 32, 16, 1], "ativacao": (relu, derivada_relu), "taxa": 0.01, "epocas": 1000, "tamanho_lote": 32, "amostras": 1000, "nome": "Alta Taxa de Aprendizado"},
    {"camadas": [X.shape[1], 128, 64, 32, 16, 1], "ativacao": (relu, derivada_relu), "taxa": 0.001, "epocas": 2000, "tamanho_lote": 32, "amostras": 1000, "nome": "Mais Épocas"},
    {"camadas": [X.shape[1], 128, 64, 32, 16, 1], "ativacao": (relu, derivada_relu), "taxa": 0.001, "epocas": 1000, "tamanho_lote": 32, "amostras": 2000, "nome": "Mais Amostras"}
]
